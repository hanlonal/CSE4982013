...
namespace IBMConsultantTool
{
    public partial class HeatMapChart : Form
    {
        ...
        public HeatMapChart(List<string> dom, List<string> cap, List<int> capNum, List<float> gap, float avgGap)
        {
